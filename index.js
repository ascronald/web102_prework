...
let amountofUnfundedGames = GAMES_JSON.filter (game =>
    game.pledged < game.goal).length;


// create a string that explains the number of unfunded games using the ternary operator
let unfundedGamesStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games so far. Currently, ${amountofUnfundedGames} games still aren't funded. Help fund more games!`;

// create a new DOM element containing the template string and append it to the description container
const unfundedGamesDescription = document.createElement('p');
unfundedGamesDescription.innerHTML = `${unfundedGamesStr}`;
